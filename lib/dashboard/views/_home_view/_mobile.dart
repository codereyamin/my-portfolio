      ...
      child: Center(
        child: Column(
          ...
          children: [
            ...
            Flexible(
              flex: 2,
              child: Text("Tuhin Ikbal Eyamin".toUpperCase(), style: GoogleFonts.josefinSans(fontSize: 22.0, fontWeight: FontWeight.w900, height: 1.3, letterSpacing: 2.3)),
            ),
                        ...
                        return MouseRegion(
                          ...
                          child: InkWell(
                            ...
                            child: Card(
                              ...
                              color: mouseRef.watch(mouseProvider).isHovered(index) ? Colors.blue.shade900 : Colors.white,
            ...
            Flexible(
              flex: 2,
              child: Text(
                "I'm Tuhin Ikbal Eyamin, A Flutter Developer",
                textAlign: TextAlign.center,
                style: GoogleFonts.josefinSans(fontWeight: FontWeight.bold, height: 1.3, fontSize: 22.0),
              ),
            ),
            Flexible(flex: 1, child: const SizedBox(height: 15.0)),
            Flexible(
              ...
              child: Padding(
                ...
                child: Text(
                  ...
                  style: TextStyle(color: ref.watch(themeProvider).isDarkMode ? kDarkCaptionColor : kLightCaptionColor, height: 1.5, fontSize: 18, fontWeight: FontWeight.bold),
                  textAlign: TextAlign.center,
                ),
              ),
            ),
