      ...
      builder: (context, child) {
        return GestureDetector(
          ...
          child: Container(
            width: 50.0,
            height: 28.0,
            decoration: BoxDecoration(borderRadius: BorderRadius.circular(24.0), color: _circleAnimation.value == Alignment.centerRight ? Colors.grey[700] : Colors.white),
            child: Padding(
              ...
              child: Container(
                ...
                child: Container(
                  ...
                  child: Icon(widget.value ? Icons.dark_mode_rounded : Icons.light_mode_rounded, size: 14, color: widget.value ? Colors.black : Colors.white),
                ),
              ),
            ),
          ),
