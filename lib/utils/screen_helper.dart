...
class ScreenHelper extends StatelessWidget {
  ...
  const ScreenHelper({super.key, required this.desktop, required this.mobile, required this.tablet});
  ...
  static bool isUnsupported(BuildContext context) => MediaQuery.of(context).size.height <= 452;
